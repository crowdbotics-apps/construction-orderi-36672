...
## Project Structure
    ...
    ├── construction_orderi_36672  # Django project configurations
...
1. Clone this repo and `cd construction_orderi_36672`
...
2. Clone this repo and `cd construction_orderi_36672`
